...
#define DRV_VERSION     __stringify(1.3.4.1klos)
#elif defined(CONFIG_EULER_KERNEL)
#define DRV_VERSION     __stringify(1.3.4.1elos)
#elif defined(CONFIG_UOS_KERNEL)
#define DRV_VERSION     __stringify(1.3.4.1uos)
#else
#define DRV_VERSION     __stringify(1.3.4.1)
#endif
