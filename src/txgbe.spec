Name: txgbe
Summary: WangXun(R) 10GbE PCI Express Ethernet Connection
Version: 1.3.4.1
Release: 1
...
# build for X86_64 platform only
...
%description
This package contains the Linux driver for the WangXun(R) 10GbE PCI Express Family of Server Adapters.
...
cd %{buildroot}
find lib -name "txgbe.*o" -exec mv {} {}.new \; \
